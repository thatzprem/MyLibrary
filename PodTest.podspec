...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/thatzprem/PodTest"
  ...
  s.author             = { "Prem Kumar" => "thatzprem@gmail.com" }
  # Or just: s.author    = "Prem Kumar"
  # s.authors            = { "Prem Kumar" => "thatzprem@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Prem Kumar"
